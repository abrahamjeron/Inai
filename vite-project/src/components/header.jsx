          ...
          {user ? (
            <div className="flex flex-col md:flex-row items-end md:items-center space-y-2 md:space-y-0 md:space-x-4 w-full md:w-auto">
              ...
              <button
                ...
                className="px-4 py-2 bg-black text-white rounded-full hover:bg-gray-800 w-full md:w-auto text-right md:text-left flex items-center justify-end md:justify-center gap-2 transition-all duration-300"
              >
                <span>Logout</span>
